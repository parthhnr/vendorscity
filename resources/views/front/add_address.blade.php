            ...
            <div class="col-lg-9">
                ...
                <div class="my_purchases_box_section">
                    <div class="custom-back-g-white">
                        <div class="col-lg-8">
                            <form role="form" id="address_form" method="post" action="{{ route('add_address') }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-fields">
                                            <input type="text" name="address1" id="address1"
                                                placeholder="Address line 1" maxlength="70">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-fields">
                                            <input type="text" name="address2" id="address2"
                                                placeholder="Address line 2" maxlength="50">
                      ...
                      <span class="checkmark"></span>
                                    ...
                                    <div class="col-box10 mb-20">
                                        <div class="form-fields-button">
                                            <button type="button" class="form-field-button update-btn"
                                                onclick="javascript:address_validation()">Add
                                                Address</button>
                                        </div>
                                    </div>
                                </div>
