        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-auto px-0">
            <div class="d-flex align-items-center justify-content-between">
              <div class="logos">
                <a class="header-logo logo2" href="{{ url('/') }}"><img src="{{asset('public/site/images/VC-LONG-COLOR.png')}}" alt="Header Logo"></a>
              </div>
              ...
              <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                ...
                <li> <a class="list-item " href="{{ url('/book-services') }}">Book Services</a></li>
          ...
          <div class="col-auto px-0">
            <div class="d-flex align-items-center">
              ...
              <a class="login-info mx10-lg mx30" href="#"><span class="d-none d-xl-inline-block">Become a</span> Vendor</a>
