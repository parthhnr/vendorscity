                ...
                <div class="container-fluid nav-header-container">
                    <div class="col-auto col-sm-6 col-lg-2 me-auto ps-lg-0">
                        <a class="navbar-brand" href="index.html">
                            <img src="images/sagar-logo.png" data-at2x="images/sagar-logo.png" alt="" class="default-logo">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8 col-md-10 bg-white modal-popup-main">
                        <div class="row">
                            <div class="col-12 col-sm-7 order-2 order-sm-1 newsletter-popup padding-6-rem-all lg-padding-4-rem-all xs-padding-3-rem-all">
                                ...
                                <form action="email-templates/subscribe-newsletter.php" method="post">
                                    <div class="newsletter-style-03 position-relative margin-25px-bottom xs-margin-15px-bottom">
                                        ...
                                        <button type="submit" class="btn no-border submit"><i class="feather icon-feather-mail m-0"></i></button>
                            ...
                            <div class="col-12 col-sm-5 cover-background order-1 order-sm-2 xs-h-150px" style="background-image:url('https://via.placeholder.com/600x802');">
                ...
                <div class="row">
                    <div class="swiper-container white-move full-screen p-0 md-h-650px sm-h-500px" data-slider-options='{ "slidesPerView": 1, "loop": true, "autoplay": { "delay": 4500, "disableOnInteraction": false },  "pagination": { "el": ".swiper-pagination", "clickable": true }, "navigation": { "nextEl": ".swiper-button-next-nav", "prevEl": ".swiper-button-previous-nav" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "effect": "slide" }'>
                        <div class="swiper-wrapper">
                            <!-- start slider item -->
                            <div class="swiper-slide top-slider-title cover-background" style="background-image:url('images/fashion1_1.jpg');">
                            ...
                            <!-- end slider item -->
                            <!-- start slider item -->
                            <div class="swiper-slide cover-background" style="background-image:url('images/fashion1_2.jpg');">
                                <div class="container h-100">
                                    <div class="row justify-content-center h-100">
                                        <div class="col-12 col-xl-6 col-sm-7 d-flex flex-column justify-content-center text-center h-100">
            ...
            <div class="container-fluid">
                <div class="row row-cols-1 row-cols-xl-4 row-cols-md-2">
                    ...
                    <div class="col shop-category-style-01 wow animate__fadeIn">
                        <div class="shop-product lg-margin-30px-bottom">
                            <div class="shop-product-image">
                                <img src="images/home-shop-modern-01.webp" class="w-100" alt=""/>
                    ...
                    <div class="col shop-category-style-01 wow animate__fadeIn" data-wow-delay="0.2s">
                        <div class="shop-product lg-margin-30px-bottom">
                            <div class="shop-product-image">
                                <img src="images/home-shop-modern-02.webp" class="w-100" alt=""/>
                                <div class="shop-product-overlay bg-transparent-gradient-light-red-orange"></div>
                            </div>
                            <div class="shop-product-content d-flex align-items-center bg-white xl-padding-20px-lr padding-30px-lr padding-5px-tb">
                    ...
                    <div class="col wow animate__fadeIn" data-wow-delay="0.4s">
                        <a href="#"><img src="images/home-shop-modern-03.webp" class="sm-margin-30px-bottom" alt=""/></a>
                    </div>
                    <!-- start category banner -->
                    <!-- start category item -->
                    <div class="col shop-category-style-01 wow animate__fadeIn" data-wow-delay="0.6s">
                        <div class="shop-product">
                            <div class="shop-product-image">
                                <img src="images/home-shop-modern-04.webp" class="w-100" alt=""/>
                                <div class="shop-product-overlay bg-transparent-gradient-light-red-orange"></div>
                            </div>
                            <div class="shop-product-content d-flex align-items-center bg-white xl-padding-20px-lr padding-30px-lr padding-5px-tb">
                        ...
                        <ul class="product-listing shop-wrapper grid grid-loading grid-5col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large text-center">
                            ...
                            <li class="grid-item">
                                <div class="product-box margin-45px-bottom lg-margin-25px-bottom xs-no-margin-bottom">
                                    ...
                                    <div class="product-image">
                                        <a href="#">
                                            <img class="default-image" src="images/F1.jpg" alt=""/>
                                            <img class="hover-image" src="images/1.webp" alt=""/>
                                        </a>
                                    ...
                                    <div class="product-footer text-center padding-25px-top xs-padding-10px-top">
                                        <a href="#" class="text-extra-dark-gray text-black-hover font-weight-500 d-inline-block">Merlon Jeans</a>
                            ...
                            <li class="grid-item featured-products">
                                <div class="product-box margin-45px-bottom lg-margin-25px-bottom xs-no-margin-bottom">
                                    ...
                                    <div class="product-image">
                                        <a href="#">
                                            <img class="default-image" src="images/F6.jpg" alt=""/>
                                            <img class="hover-image" src="images/1_1.webp" alt=""/>
                                        </a>
                                        <div class="product-overlay bg-gradient-extra-midium-gray-transparent"></div>
                                    ...
                                    <!-- start product footer -->
                                    <div class="product-footer text-center padding-25px-top xs-padding-10px-top">
                                        <a href="#" class="text-extra-dark-gray text-black-hover font-weight-500 d-inline-block">Cotton Jacket</a>
                            ...
                            <li class="grid-item best-sellers">
                                <div class="product-box margin-45px-bottom lg-margin-25px-bottom xs-no-margin-bottom">
                                    ...
                                    <div class="product-image">
                                        <a href="#">
                                            <img class="default-image" src="images/F7.jpg" alt=""/>
                                            <img class="hover-image" src="images/1_2.webp" alt=""/>
                                        </a>
                                        <div class="product-overlay bg-gradient-extra-midium-gray-transparent"></div>
                                        <div class="product-hover-bottom text-center padding-35px-tb">
                                            <a href="#" class="product-link-icon move-top-bottom" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Add to cart"><i class="feather icon-feather-shopping-cart"></i></a>
                                    ...
                                    <!-- start product footer -->
                                    <div class="product-footer text-center padding-25px-top xs-padding-10px-top">
                                        <a href="#" class="text-extra-dark-gray text-black-hover font-weight-500 d-inline-block">Tennis Shorts</a>
                            ...
                            <li class="grid-item featured-products">
                                <div class="product-box margin-45px-bottom lg-margin-25px-bottom xs-no-margin-bottom">
                                    ...
                                    <div class="product-image">
                                        <a href="#">
                                            <img class="default-image" src="images/F4.jpg" alt=""/>
                                            <img class="hover-image" src="images/4.webp" alt=""/>
                                    ...
                                    <!-- start product footer -->
                                    <div class="product-footer text-center padding-25px-top xs-padding-10px-top">
                                        <a href="#" class="text-extra-dark-gray text-black-hover font-weight-500 d-inline-block">Cotton Dark Shirt</a>
                                        <div class="product-price text-medium">&#8377;370</div>
                                    </div>
                                    <!-- end product footer -->
                                </div>
                           ...
                           <li class="grid-item featured-products">
                            <div class="product-box margin-45px-bottom lg-margin-25px-bottom xs-no-margin-bottom">
                                ...
                                <div class="product-image">
                                    <a href="#">
                                        <img class="default-image" src="images/F3.jpg" alt=""/>
                                        <img class="hover-image" src="images/3.webp" alt=""/>
                                        <span class="product-badge green">sale</span>
                                    </a>
                                    <div class="product-overlay bg-gradient-extra-midium-gray-transparent"></div>
                                    <div class="product-hover-bottom text-center padding-35px-tb">
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-2">
                    ...
                    <div class="col md-margin-30px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        <div class="d-flex align-items-center cover-background h-100" style="background-image:url('images/b1.jpg');">
                    ...
                    <div class="col md-margin-20px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                        <div class="d-flex align-items-center cover-background h-100" style="background-image:url('images/b2.jpg');">
                    ...
                    <div class="col-12 blog-content px-md-0">
                        <ul class="blog-classic blog-wrapper grid grid-loading grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large">
                            ...
                            <li class="grid-item wow animate__fadeIn">
                                <div class="blog-post">
                                    <div class="blog-post-image margin-40px-bottom md-margin-35px-bottom xs-margin-25px-bottom">
                                        <a href="#"><img src="images/bg1.webp" alt=""/></a>
                                    </div>
                            ...
                            <li class="grid-item wow animate__fadeIn" data-wow-delay="0.2s">
                                <div class="blog-post">
                                    <div class="blog-post-image margin-40px-bottom md-margin-35px-bottom xs-margin-25px-bottom">
                                        <a href="#"><img src="images/bg2.webp" alt=""/></a>
                                    </div>
                                    <div class="post-details">
                            ...
                            <li class="grid-item wow animate__fadeIn" data-wow-delay="0.4s">
                                <div class="blog-post">
                                    <div class="blog-post-image margin-40px-bottom md-margin-35px-bottom xs-margin-25px-bottom">
                                        <a href="#"><img src="images/bg3.webp" alt=""/></a>
                                    </div>
                                    <div class="post-details">
                            ...
                            <li class="grid-item wow animate__fadeIn" data-wow-delay="0.6s">
                                <div class="blog-post">
                                    <div class="blog-post-image margin-40px-bottom md-margin-35px-bottom xs-margin-25px-bottom">
                                        <a href="#"><img src="images/bg4.webp" alt=""/></a>
                                    </div>
                                    <div class="post-details">
                ...
                <div class="container">
                    <div class="row row-cols-1 row-cols-md-4 row-cols-sm-3 justify-content-center">
                        ...
                        <div class="col col-lg-3 col-sm-6 offset-sm-2 offset-md-0 order-lg-0 text-md-center text-lg-start last-paragraph-no-margin margin-25px-bottom">
                            <a href="#" class="footer-logo margin-15px-bottom margin-5px-top d-inline-block">
                                <img src="images/sagar-logo.png" alt=""></a>
