<div class="wishlist_left_side">
   <div class="wishlist_account_name">
      <h5>Rohini Chandrashekhar</h5>
      <p>rohinichandrashekhar@gmail.com</p>
   </div>
   <div class="nsp_acc_all_list">
      <div class="purchase_wishlist_help">
         <ul>
            ...
            <li>
               <a href="{{url('/my-profile')}}">My Profile <img class="purchase_img"
                  src="{{asset('public/site/images/Vector-left.png')}}"></a>
            </li>
            <li>
               <a href="#">Log out <img class="purchase_img"
                  src="{{asset('public/site/images/Vector-left.png')}}"></a>
            </li>
         </ul>
      </div>
