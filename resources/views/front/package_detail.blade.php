...
@endphp
  <section class="breadcumb-section pt-0 container">
      <div class="cta-service-single cta-banner mx-auto maxw1700 pt120 pt60-sm pb120 pb60-sm bdrs16 position-relative overflow-hidden d-flex align-items-center mx20-lg px30-lg">
        ...
        <img class="service-v1-vector bounce-y d-none d-xl-block" src="{{ asset('public/site/images/vector-img/vector-service-v1.png')}}" alt="">
        <div class="container">
            ...
            <div class="col-xl-7">
              <div class="position-relative">
                ...
                <div class="list-meta mt30">
                  ...
                  <p class="mb-0 dark-color fz14 list-inline-item ml25 ml15-sm mb5-sm ml0-xs"><i class="flaticon-file-1 vam fz20 me-2"></i> 500+ Bookings</p>
              ...
              <div class="service-single-sldier vam_nav_style slider-1-grid owl-carousel owl-theme mb60">
                <div class="item">
                  <div class="thumb p50 p30-sm">
                    <img src="{{ asset('public/upload/packages/' . $package_detail->image) }}" alt="" class="w-100"></div>
                </div>
                <div class="item">
                  <div class="thumb p50 p30-sm">
                    <img src="{{ asset('public/upload/packages/' . $package_detail->image) }}" alt="" class="w-100"></div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="mbp_first position-relative d-flex align-items-center justify-content-start mb30-sm">
                          <img src="{{ asset('public/site/images/blog/comments-2.png')}}" class="mr-3" alt="comments-2.png">
                          <div class="ml20">
...
clicks.</p>
                          ...
                          <div class="list-style1">
                            <ul class="">
                              <li class="mb15"><i class="far fa-check text-thm3 bgc-thm3-light fa-check-custom"></i>Trusted professionals</li>
                              <li><i class="far fa-check text-thm3 bgc-thm3-light fa-check-custom"></i>100% satisfaction guaranteed</li>
                              <li><i class="far fa-check text-thm3 bgc-thm3-light fa-check-custom"></i>Same day delivery</li>
                            </ul>
                          </div>
                          <hr class="opacity-100 mb20">
                          <div class="d-grid">
                            <a href="" class="ud-btn btn-thm">Add to cart <i class="fal fa-arrow-right-long"></i></a>
                          </div>
                        </div>
                      </div>
