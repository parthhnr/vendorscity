          ...
          <div class="col-lg-9">
            ...
            <div class="row">
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/1.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Villa shifting in Dubai </a></h5>
                    <div class="review-meta d-flex align-items-center">
                      <p>Moving can be stressful, be it international or within the Emirates. You can book professional movers in Dubai in just a few clicks.</p>
                    </div>
                    <hr class="my-2">
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/2.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Office shifting in Dubai</a></h5>
                    <div class="review-meta d-flex align-items-center">
                      <p>Moving can be stressful, be it international or within the Emirates. You can book professional movers in Dubai in just a few clicks.</p>
                    </div>
                    <hr class="my-2">
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/3.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Storage in Dubai</a></h5>
                    <div class="review-meta d-flex align-items-center">
                      <p>Moving can be stressful, be it international or within the Emirates. You can book professional movers in Dubai in just a few clicks.</p>
                    </div>
                    <hr class="my-2">
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/4.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Villa shifting in Dubai</a></h5>
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/5.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Office shifting in Dubai</a></h5>
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/6.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Storage in Dubai</a></h5>
               ...
               <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/7.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Villa shifting in Dubai</a></h5>
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/8.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Office shifting in Dubai</a></h5>
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  <div class="list-thumb">
                    <img class="w-100" src="{{asset('public/site/images/listings/9.png')}}" alt="">
                    <a href="" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                  </div>
                  <div class="list-content">
                    <h5 class="list-title"><a href="page-services-single.html">Storage in Dubai</a></h5>
