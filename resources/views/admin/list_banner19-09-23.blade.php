						   ...
						   <table class="table table-center table-hover datatable">
							  ...
							  <tbody>
								 ...
								 <tr>
									...
									<td><img src="{{ url('public/upload/banner/small/'.$data->image) }}" width="50px" height="50px"></td>
									...
									<td class="text-right">
										<a class="btn btn-primary" href="{{ route('banner.edit',$data->id) }}"><i class="far fa-edit"></i></a>
									</td>
