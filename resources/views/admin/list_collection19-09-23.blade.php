			...
			<div class="page-header">
			   ...
			   <div class="row align-items-center">
				  ...
				  <div class="col-auto">
					 ...
					 <a class="btn btn-primary me-1" href="{{ route('collection.create') }}">
			   ...
			   <div class="col-sm-12">
				  ...
				  <div class="card card-table">
					 ...
					 <div class="card-body">
					 	...
					 	<form id="form" action="{{ route('delete_collection') }}" enctype="multipart/form-data">
						   ...
						   <table class="table table-center table-hover datatable">
							  ...
							  <tbody>
								 ...
								 <tr>
									...
									<td><img src="{{ url('public/upload/collection/large/'.$data->image) }}" width="50px" height="50px"></td>

									<td class="left"><input type="text" class="form-control" value="{{$data->set_order}}" onchange="updateorder_popup(this.value, '{{$data->id}}');"  /></td>

									<td class="text-right">

										<a class="btn btn-primary" href="{{ route('collection.edit',$data->id) }}"><i class="far fa-edit"></i></a>
	...
	<div class="modal custom-modal fade" id="set_order_model" role="dialog">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-body">
					<div class="modal-text text-center">
						<h3>Are you sure you want to Set order of Collection</h3>
