			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<form id="category_form" action="{{ route('size.update',$size->id) }}" method="POST" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row">
								<div class="form-group">
									<label for="name">Name</label>
									<input id="name" name="name" type="text" class="form-control" placeholder="Enter Name" value="{{$size->name}}" />
								</div>
