						...
						<div class="row align-items-center">
							...
							<div class="col-auto">
								<a class="btn btn-primary me-1" href="{{ route('city.create') }}">
							  	...
							  	<a class="btn btn-danger me-1" href="javascript:void('0');" onclick="delete_city();return false;">
									...
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
											...
											<tbody>
												...
												<tr>
													<td>
														<input name="selected[]" id="selected" value="{{$data->id}}" type="checkbox"  class="minimal-red" style="height: 20px;width: 20px;border-radius: 0px;color: red;">
													</td>
													...
													@if(in_array('9',$edit_perm))
													<td class="text-right">
														<a class="btn btn-primary" href="{{ route('city.edit',$data['id']) }}"><i class="far fa-edit"></i></a>
													</td>
													@endif
												</tr>
												@endforeach
