                           ...
                           <form action="{{ route('base_on_service_lead') }}" id="category_form_new" method="POST"
                               ...
                               <div class="row">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <span id="state_chang">
                                           <select class="form-control" id="state" name="state" onchange="city_change(this.value);">
                                ...
                                <div class="form-group">
                                    <label for="city">Services</label>
                                        <select class="form-control" id="services" name="services[]" multiple="multiple" onchange="subservice_change(this.value);">
                                ...
                                <div class="form-group">
                                    ...
                                    <span id="subservice_option">
                                        <select class="form-control" id="sub_service" name="sub_service[]" multiple="multiple">
