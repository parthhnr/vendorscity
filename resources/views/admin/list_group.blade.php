               ...
               <div class="row align-items-center">
                   ...
                   @if (in_array('4', $edit_perm))
                       <div class="col-auto">
                           ...
                           <a class="btn btn-primary me-1" href="{{ route('group.create') }}">
           ...
           <div class="row">
               <div class="col-sm-12">
                   ...
                   <div class="card card-table">
                       <div class="card-body">
                           <form id="form" action="{{ route('delete_group') }}" enctype="multipart/form-data">
                                                   ...
                                                   @if (in_array('4', $edit_perm))
                                                       <td class="text-right">
                                                           <a class="btn btn-primary"
                                                               href="{{ route('group.edit', $data->id) }}"><i
