                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control"
                                        placeholder="Enter Name" value="{{ $blog->name }}" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Image (Size : 525px X 370px )</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control" placeholder="Enter Description">{{ $blog->description }}</textarea>
