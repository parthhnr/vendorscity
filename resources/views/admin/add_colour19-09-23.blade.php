			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<form id="category_form" action="{{ route('colour.store') }}" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="row">
								...
								<div class="form-group">
									...
									<input id="code" name="code" type="text" class="form-control" placeholder="Enter Colour Code" value="" />
								</div>
							</div>
