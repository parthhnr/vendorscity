                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Group</label>
                                        <span id="group_change">
                                            <select name="group_id" id="group_id" class="form-control"
                                                onchange="category_change(this.value);">
                                                <option value="">Select Group</option>
                                                @foreach ($group_old as $group_data)
                                                    <option value="{{ $group_data->id }}"
                                                        @if ($product->group_id == $group_data->id) {{ 'selected' }} @endif>
                                                        {{ $group_data->name }}</option>
                                                @endforeach
                                            </select>
                                        </span>
                                        <p id="group_id" style="display: none;color: red"></p>
                                        @error('name')
