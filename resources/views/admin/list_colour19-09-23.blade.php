			...
			<div class="page-header">
			   <div class="row align-items-center">
				  ...
				  <div class="col-auto">
					 ...
					 <a class="btn btn-primary me-1" href="{{ route('colour.create') }}">
			...
			<div class="row">
			   <div class="col-sm-12">
				  ...
				  <div class="card card-table">
					 <div class="card-body">
					 	<form id="form" action="{{ route('delete_colour') }}" enctype="multipart/form-data">
						   ...
						   <table class="table table-center table-hover datatable">
							  ...
							  <tbody>
								 ...
								 <tr>
									...
									<td>{{$data->code}}</td>
									<td class="text-right">
										<a class="btn btn-primary" href="{{ route('colour.edit',$data->id) }}"><i class="far fa-edit"></i></a>
									</td>
